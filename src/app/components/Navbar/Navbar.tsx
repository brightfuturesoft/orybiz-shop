        ...
        <div className="flex h-16 items-center justify-between relative">
          ...
          <nav className="hidden md:flex flex-grow justify-center">
            <ul className="flex items-center space-x-8 lg:space-x-12">
              <li className="cursor-pointer text-black hover:text-red-500 transition-colors">Home</li>
              <li className="cursor-pointer text-black hover:text-red-500 transition-colors">Contact</li>
              <li className="cursor-pointer text-black hover:text-red-500 transition-colors">About</li>
              <li className="cursor-pointer text-black hover:text-red-500 transition-colors">Sign Up</li>
            </ul>
          </nav>
